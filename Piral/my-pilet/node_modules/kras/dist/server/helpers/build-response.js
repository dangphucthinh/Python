...
exports.fromMissing = exports.fromJson = exports.fromHar = exports.fromNode = void 0;
...
function fromNode(ans, body, injector) {
    const headers = {};
...
function fromHar(url, response, injector) {
...
function fromJson(url, statusCode, statusText, headers, content, injector) {
    return buildResponse({
        statusCode,
        statusText,
        url,
...
exports.fromMissing = fromMissing;
