...
function createMetadata(outDir, outFile, pilets) {
    return (0, common_1.writeJson)(outDir, outFile, pilets.map((p) => (Object.assign({ name: p.package.name, version: p.package.version, link: `./${p.id}/${p.outFile}` }, (0, common_1.getPiletSpecMeta)(p.path, p.outDir)))));
}
...
function buildPilet(baseDir = process.cwd(), options = {}) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (type === 'standalone') {
            ...
            yield createMetadata(outDir, '$pilet-api', pilets);
            if (isEmulator) {
            ...
            (0, common_1.progress)('Copying files ...');
            yield copyPilets(outDir, pilets);
            yield createMetadata(outDir, manifest, pilets);
