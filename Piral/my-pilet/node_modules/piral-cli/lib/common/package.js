...
function retrievePiletsInfo(entryFile) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const externals = (0, npm_1.makeExternals)(allDeps, info.externals);
        return Object.assign(Object.assign({}, info), { externals, name: packageInfo.name, version: packageInfo.version, dependencies: {
            ...
            }, scripts: packageInfo.scripts, ignored: checkArrayOrUndefined(packageInfo, 'preservedDependencies'), root: (0, path_1.dirname)(packageJson) });
    });
}
...
function patchPiletPackage(root, name, version, piralInfo, fromEmulator, newInfo) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const peerModules = [];
        const allExternals = (0, npm_1.makePiletExternals)(piralDependencies, externals, fromEmulator, piralInfo);
        ...
        if (typeof sharedImports === 'object' && sharedImports) {
            for (const depName of Object.keys(sharedImports)) {
                ...
                if (typeof url !== 'string') {
                    ...
                    const hash = yield (0, http_1.getHashFromUrl)(url);
                    dependencies.push({
                        id: `${depName}@${hash}`,
                        entry: url,
                        name: depName,
