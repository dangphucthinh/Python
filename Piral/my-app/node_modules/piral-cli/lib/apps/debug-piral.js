...
function debugPiral(baseDir = process.cwd(), options = {}) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield ((_c = hooks.beforeOnline) === null || _c === void 0 ? void 0 : _c.call(hooks, { krasServer, krasConfig, open, port }));
        yield krasServer.start();
        (0, common_1.openBrowser)(open, port);
        yield ((_d = hooks.afterOnline) === null || _d === void 0 ? void 0 : _d.call(hooks, { krasServer, krasConfig, open, port }));
