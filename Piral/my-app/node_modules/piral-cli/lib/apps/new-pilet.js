...
always-auth=true`, forceOverwrite);
            ...
            if (!isLocal) {
                ...
                yield (0, common_1.installPackage)(npmClient, packageRef, root, '--save-dev');
            }
            else {
            ...
            const { preScaffold, postScaffold, files } = (0, common_1.getPiletsInfo)(piralInfo);
            if (preScaffold) {
            ...
            yield (0, common_1.scaffoldPiletSourceFiles)(template, registry, data, forceOverwrite);
            if (isEmulator) {
            ...
            if (install) {
                ...
                const monorepoKind = yield (0, common_1.detectMonorepo)(root);
                if (monorepoKind === 'lerna') {
                    yield (0, common_1.bootstrapMonorepo)(root);
                }
                else {
                    yield (0, common_1.installDependencies)(npmClient, root);
                }
            }
            if (postScaffold) {
